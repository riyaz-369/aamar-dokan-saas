...
import { CreateBillingFormSchema } from "./CreateBillingFormSchema";
...
const CreateBillingForm = () => {
  ...
  const form = useForm<z.infer<typeof CreateBillingFormSchema>>({
    resolver: zodResolver(CreateBillingFormSchema),
    defaultValues: {
      title: "",
      slug: "",
      tags: "",
